...
with mlflow.start_run(run_name=run_name):
    ...
    mlflow.log_input(mlflow_dataset, context="seed_stability")
...
# ============================================================
    ...
    # ============================================================
        ...
        n_learned_params = {"intensity_function":4}
        n_params = n_learned_params[delta.__name__] + model.net.num_trainable_parameters()
        ...
        samples["test"].append(test_metrics)
        samples["train"].append(train_metrics)
# ============================================================
#                        ENTRENAMIENTO
# ============================================================
    
    test_samples_df  = pd.DataFrame(samples["test"])
    ...
    log_params = {"number_of_samples":N_SAMPLES,
                  "learning_rate":lr,
